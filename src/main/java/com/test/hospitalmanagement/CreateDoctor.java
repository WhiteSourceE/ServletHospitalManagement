...
import com.test.hospitalmanagement.database.JDBCConfiguration;
...
public class CreateDoctor extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "insert into doctor(name,email,phone,age,joindate,salary,specialist,patients) values(?,?,?,'" + Integer.valueOf(age) + "',?,?,?,?)";
